...
| Identificadores | ID de usuario, identificador estable de Google/Apple, token push cuando se habilite | autenticación, vinculación segura y notificaciones | no se venden |
...
| Información financiera | identificadores de pago, monto, estado, referencia de transferencia y últimos cuatro dígitos bancarios | cobro, conciliación y reembolso | Klap y personal autorizado de Finanzas |
...
| Intercambios históricos de Facebook, si existieran | purga después de 7 días |
...
- Facebook Login está deshabilitado y no forma parte del flujo de autenticación de la versión final.
- El código de la versión auditada no debe exponer rutas ni botones de Facebook; tampoco incorpora App Events publicitarios ni solicitud de IDFA.
...
- Confirmar en el binario final que no exista SDK de Meta/Facebook ni tracking publicitario.
...
- Claves privadas Apple, Klap, Supabase o SMTP en el frontend.
